...
import kotlinx.android.synthetic.main.activity_blue_board.*
...
class BlueBoard : Board() {
    ...
    private val MAIN = R.drawable.bg_blue_main_board
    private val SUB = R.drawable.bg_blue_sub_board
        ...
        listener = object : ChildEventListener {
            ...
            override fun onChildChanged(dataSnapshot: DataSnapshot, p1: String?) {
                if (dataSnapshot.value != "GiveUp") {
                    ...
                    updateScore(10)
                    Toast.makeText(this@BlueBoard, "YOU WIN!!, YOUR OPPONENT GAVE UP", Toast.LENGTH_SHORT).show()
                    endGame()
                }
            }
    ...
    private fun give_up() {
        ...
        updateScore(-10)
        Toast.makeText(this, "YOU LOST!!, YOU GAVE UP", Toast.LENGTH_SHORT).show()
        endGame()
    }
}